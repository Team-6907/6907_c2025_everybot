...
public class SimpleCoralAuto extends Command {
   ...
   *
   * <p>There are many ways to write autos, this style will work well for most simple auto routines.
   * For more advanced routines you may want a different structure and to use more sensors.
   *
   * <p>Here we use two timer gates, after the robot has finished driving for the first 3.25
  ...
  public void execute() {
    ...
    /**
     * Once the timer is greater than drive_seconds but less than exjest seconds, the code inside
     * will run, here we stop the drivetrain and exjest the coral.
     */
