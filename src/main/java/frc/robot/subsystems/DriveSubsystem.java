...
public class DriveSubsystem extends SubsystemBase {
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber(
        "leftEncoder Value", leftEncoder.getPositionSinceBoot().getValueAsDouble());
    SmartDashboard.putNumber(
        "rightEncoderValue", rightEncoder.getPositionSinceBoot().getValueAsDouble());
  ...
  /**
   * Use this to control your drive train, with one axis of the controller moving the robot forwards
   * and backwards with the other axis turning the robot.
   *
   ...
   * and backwards with the other axis turning the robot.
   *
   * <p>Additionally we use a pidcontroller to make the robot move as your axises input.
   *
   * @param xaxisSpeed the speed going forward
   * @param zaxisRotate the speed turning
   */
